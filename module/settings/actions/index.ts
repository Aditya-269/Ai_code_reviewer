...
return {
    ...
    console.error("Error disconnecting all repositories:", JSON.stringify(error, null, 2), error);
    return {
        success: false,
        error: error instanceof Error ? error.message : "Failed to disconnect all repositories"
    }
  }
}